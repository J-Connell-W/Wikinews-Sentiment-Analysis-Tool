...
def translation(story_content, story):
    ...
    elif story.original_language == "Spanish" and story.translation_language == "English":
...
def translation_english_to_spanish(story_content):
    translator_to_spanish = pipeline("translation_en_to_es", model="Helsinki-NLP/opus-mt-en-es")
